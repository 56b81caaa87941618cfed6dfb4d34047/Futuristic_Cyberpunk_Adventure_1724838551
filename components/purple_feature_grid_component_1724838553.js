...
<template>
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-gradient-to-br from-purple-600 via-pink-500 to-indigo-600 p-8 rounded-xl shadow-lg">
        <!-- Feature 1 -->
        <div id="feature-1">
            <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
               ...
               <div class="flex" id="feature-1-title-container">
                    <h4 id="feature-1-title" class="flex-1 text-yellow-300 font-bold text-lg">Neon-Drenched Metropolis</h4>
                </div>
            </div>
            <div class="flex" id="feature-1-description-container">
                <p id="feature-1-description" class="flex-1 text-sm text-white">Immerse yourself in a sprawling, vertically-stacked city where neon lights pierce through the smog and danger lurks around every corner.</p>
            </div>
        </div>
        ...
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container">
                    <h4 id="feature-2-title" class="flex-1 text-cyan-300 font-bold text-lg">Augmented Reality Interface</h4>
                </div>
            </div>
            <div class="flex" id="feature-2-description-container">
                <p id="feature-2-description" class="flex-1 text-sm text-white">Navigate the urban jungle with cutting-edge AR tech, accessing real-time data and hacking opportunities at the blink of an eye.</p>
            </div>
        </div>
        ...
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container">
                    <h4 id="feature-3-title" class="flex-1 text-green-300 font-bold text-lg">Cybernetic Customization</h4>
                </div>
            </div>
            <div class="flex" id="feature-3-description-container">
                <p id="feature-3-description" class="flex-1 text-sm text-white">Upgrade your body with state-of-the-art implants and enhancements, pushing the boundaries between human and machine.</p>
            </div>
        </div>
        ...
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container">
                    <h4 id="feature-4-title" class="flex-1 text-red-300 font-bold text-lg">Corporate Warfare</h4>
                </div>
            </div>
            <div class="flex" id="feature-4-description-container">
                <p id="feature-4-description" class="flex-1 text-sm text-white">Dive into a world where megacorporations rule and loyalty is bought. Choose your allegiances wisely as you climb the power ladder.</p>
            </div>
        </div>
        ...
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container">
                    <h4 id="feature-5-title" class="flex-1 text-blue-300 font-bold text-lg">Netrunner Missions</h4>
                </div>
            </div>
            <div class="flex" id="feature-5-description-container">
                <p id="feature-5-description" class="flex-1 text-sm text-white">Jack into the matrix and execute high-stakes hacking operations, battling AI security systems and rival netrunners in cyberspace.</p>
            </div>
        </div>
        ...
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container">
                    <h4 id="feature-6-title" class="flex-1 text-orange-300 font-bold text-lg">Dystopian Narrative</h4>
                </div>
            </div>
            <div class="flex" id="feature-6-description-container">
                <p id="feature-6-description" class="flex-1 text-sm text-white">Experience a gripping story of rebellion, survival, and identity in a world where technology has both elevated and corrupted humanity.</p>
            </div>
        </div>
    </div>
    <div class="text-center mt-8 animate-pulse">
        <h2 class="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500">
