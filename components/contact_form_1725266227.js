<template>
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        <h3 class="text-black font-semibold text-xl">Join the Resistance</h3>
        <p class="mt-3 text-black w-fit">Ready to hack the system? We need your skills, Runner.</p>
      </div>
      <form @submit.prevent class="space-y-5 mt-5">
        <div>
          <label class="font-medium text-black">Enter your street name</label>
          <input
            type="text"
            required
        ...
        <div>
          <label class="font-medium text-black">Drop your secure comms link</label>
          <input
            type="email"
            required
            class="w-full mt-2 px-3 py-2 text-black bg-white border border-gray-300 focus:border-green-500 shadow-sm rounded-lg"
        ...
        <div>
          <label class="font-medium text-black">Which megacorp are you affiliated with?</label>
        ...
        <div>
          <label class="font-medium text-black">What's your cyberdeck model?</label>
        ...
        <div>
          <label class="font-medium text-black">List your augmentations</label>
          <textarea
            required
        ...
        <button class="w-full px-4 py-2 text-white font-medium bg-green-600 hover:bg-green-500 active:bg-green-700 rounded-lg duration-150">
          Tell us about your most daring hack
        </button>
      </form>
    </div>
  </main>
